...
export const LEVELS: LevelDef[] = [
  {
    ...
    desc: '<h4>진단 결과</h4>아이돌봄에 관심은 있지만 아직 자격과 경험이 부족한 단계입니다.',
  ...
  },
  {
    ...
    desc: '<h4>진단 결과</h4>높은 수준의 자격과 실전 대처 능력을 갖추고 있습니다.',
  ...
  },
  {
    ...
    desc: '<h4>진단 결과</h4>최고 수준의 자격과 완성도 높은 상황 대처 능력을 보유하고 있습니다.',
